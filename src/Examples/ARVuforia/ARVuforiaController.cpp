...
namespace Eegeo
{
    namespace AR
    {
        ...
        int ARVuforiaController::LoadTrackerData()
        {
            ...
            {
                EXAMPLE_LOG("Failed to load tracking data set because the ObjectTracker has not"
                    " been initialized.");
                return 0;
            }
            ...
            {
                EXAMPLE_LOG("Failed to create a new tracking data.");
                return 0;
            }
            ...
            {
                EXAMPLE_LOG("Failed to activate data set.");
                return 0;
            }
            
            EXAMPLE_LOG("Successfully loaded and activated data set.");
            return 1;
        }
        ...
        int ARVuforiaController::DestroyTrackerData()
        {
            ...
            if (objectTracker == NULL)
            {
                EXAMPLE_LOG("Failed to destroy the tracking data set because the ObjectTracker has not"
                    " been initialized.");
                return 0;
            }
            ...
            if (dataSetStonesAndChips != 0)
            {
                ...
                {
                    EXAMPLE_LOG("Failed to destroy the tracking data set StonesAndChips because the data set "
                ...
                {
                    EXAMPLE_LOG("Failed to destroy the tracking data set StonesAndChips.");
                    return 0;
                }
                
                EXAMPLE_LOG("Successfully destroyed the data set StonesAndChips.");
            ...
            if (dataSetTarmac != 0)
            {
                ...
                {
                    EXAMPLE_LOG("Failed to destroy the tracking data set Tarmac because the data set "
                        "could not be deactivated.");
                    return 0;
                }
                ...
                {
                    EXAMPLE_LOG("Failed to destroy the tracking data set Tarmac.");
                    return 0;
                }
                
                EXAMPLE_LOG("Successfully destroyed the data set Tarmac.");
                dataSetTarmac = 0;
            }
        ...
        void ARVuforiaController::ConfigureVideoBackground()
        {
            ...
            //{
                EXAMPLE_LOG("configureVideoBackground PORTRAIT");
                ...
                * (screenHeight / (float)videoMode.mWidth);
                ...
                {
                    EXAMPLE_LOG("Correcting rendering background size to handle missmatch between screen and video aspect ratios.");
           ...
           /* }
            ...
            EXAMPLE_LOG("Configure Video Background : Video (%d,%d), Screen (%d,%d), mSize (%d,%d)", videoMode.mWidth, videoMode.mHeight, screenWidth, screenHeight, config.mSize.data[0], config.mSize.data[1]);
        ...
        void ARVuforiaController::InitApplicationNative(int width, int height)
        {
            ...
            {
                EXAMPLE_LOG("Function getTextureCount() not found.");
                return;
            }
            ...
            if (!textureCount)
            {
                EXAMPLE_LOG("getTextureCount() returned zero.");
                return;
            }
            ...
            {
                EXAMPLE_LOG("Function getTexture() not found.");
                return;
            }
            ...
            for (int i = 0; i < textureCount; ++i)
            {
                ...
                {
                    EXAMPLE_LOG("GetTexture() returned zero pointer");
                    return;
                }
